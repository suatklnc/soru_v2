...
def debug_is_instruction(pdf_path, page_num):
    """is_instruction fonksiyonunu debug eder"""
    
    doc = fitz.open(pdf_path)
    page = doc.load_page(page_num)
    
    print(f"=== SAYFA {page_num + 1} IS_INSTRUCTION DEBUG ===")
...
if __name__ == "__main__":
    ...
    debug_is_instruction("bolunmus_pdf.pdf", 0)
