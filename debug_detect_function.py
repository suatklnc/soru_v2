...
def debug_detect_function(pdf_path, page_num):
    """detect_questions_on_page fonksiyonunu debug eder"""
    
    doc = fitz.open(pdf_path)
    page = doc.load_page(page_num)
    
    print(f"=== SAYFA {page_num + 1} DETECT FUNCTION DEBUG ===")
    ...
    print("=== DETECT FUNCTION SIMULASYONU ===")
...
if __name__ == "__main__":
    ...
    debug_detect_function("bolunmus_pdf.pdf", 0)
